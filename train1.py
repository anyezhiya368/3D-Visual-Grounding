...
def filter_stat_dict(model, exp_path, exp_name, use_cuda, epoch=0):
...
if __name__ == '__main__':
    ...
    state_dict = filter_stat_dict(model, cfg.filter_path, cfg.filter.split('/')[-1][:-5], use_cuda, epoch=100)
